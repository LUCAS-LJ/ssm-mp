/*@版权所有LIJIANG*/ 
package com.ssm.pay.common.utils.reflection;
...
* @author Jiang.Li
* @version 2016年1月29日 上午10:27:45
*/
@SuppressWarnings("unchecked")
public class SsmReflectionUtils {
    ...
    private static Logger logger = LoggerFactory.getLogger(SsmReflectionUtils.class);
	...
	public static <T> T invokeGetter(Object target,String propertyName){
    	String geterMethodName = "get" + org.apache.commons.lang3.StringUtils.capitalize(propertyName);
    	 return (T) invokeMethod(target, geterMethodName, new Class[] {},
                 new Object[] {});
    }
    ...
    public static void invokeSetter(Object obj, String propertyName, Object value) {
        String setterMethodName = SETTER_PREFIX + SsmStringUtils.capitalize(propertyName);
