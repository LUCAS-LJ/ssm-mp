...
<div>
    <form id="organ_user_form" class="dialog-form" method="post">
        ...
        <div>
            <label>机构用户:</label>
            <input type="select" id="userIds" name="userIds" style="width: 260px;"/>
        </div>
        <div>
            <label>主管:</label>
            <input type="select" id="managerUserId" name="managerUserId" style="width: 260px;"/>
        </div>
        <div>
            <label>分管领导人:</label>
            <input type="select" id="superManagerUserId" name="superManagerUserId"
                   style="width:260px;" data-options="validType:['combogridRequired[\'#superManagerUserId\']']">
            <span class="tree-icon tree-file easyui-icon-tip easyui-tooltip"
                  title="输入登录名，按回车键即可搜索." ></span>
        </div>
    </form>
</div>