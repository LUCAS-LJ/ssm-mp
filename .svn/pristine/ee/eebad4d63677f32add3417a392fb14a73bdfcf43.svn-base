/*@版权所有LIJIANG*/ 
package com.ssm.pay.common.utils.collections;

import java.util.Map;
import java.util.Map.Entry;

import com.ssm.pay.common.utils.SsmObjectUtils;
import com.ssm.pay.common.utils.SsmStringUtils;

/** 
* MAP 工具类,实现MAP的一些常用操作
* @author Jiang.Li
* @version 2016年1月28日 下午10:27:41
*/
public class SsmMapUtils {
	/**
     * 判断map是否为空或大小为0
     * 
     * @param str
    ...
    public static boolean putMapNotEmptyKey(Map<String, String> map, String key, String value) {
        if (map == null || SsmStringUtils.isEmpty(key)) {
            return false;
        }
    ...
    public static boolean putMapNotEmptyValue(Map<String, String> map, String key, String value) {
        ...
        if (!SsmStringUtils.isEmpty(value)) {
            try {
                map.put(key, value);
            } catch (Exception e) {
                return false;
    ...
    public static <V> String getKeyByValue(Map<String, V> map, V value) {
        ...
        for (Entry<String, V> entry : map.entrySet()) {
            if (SsmObjectUtils.isEquals(entry.getValue(), value)) {
                return entry.getKey();
            }
        }
