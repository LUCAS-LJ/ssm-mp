...
/** 文件大小处理
* @author Jiang.Li
* @version 2016年4月13日 下午8:15:13
*/
public class SsmPrettyMemoryUtils {
    ...
    public static void main(String[] args) {
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1023));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * UNIT));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * 1023));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * 1023 * 1023 * 1023));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * UNIT * UNIT));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT * UNIT));
        System.out.println(SsmPrettyMemoryUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT * UNIT * UNIT));
    }
}
