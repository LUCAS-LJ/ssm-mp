...
* @author Jiang.Li
* @version 2016年1月28日 下午10:32:16
*/
public class SsmRemoteContentServlet extends HttpServlet
{
    ...
    private static Logger logger = LoggerFactory.getLogger(SsmRemoteContentServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (SsmStringUtils.isBlank(contentUrl)) {
