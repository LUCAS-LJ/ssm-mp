...
/** 使用HandlerMethodArgumentResolver 自定义解析器实现请求参数绑定方法参数 
* @author Jiang.Li
* @version 2016年2月27日 下午10:14:36
*/
public class SsmSecureModelAttributeMethodArgumentResolver implements HandlerMethodArgumentResolver{
	
    @SuppressWarnings("unused")
    private static Logger logger = LoggerFactory.getLogger(SsmSecureModelAttributeMethodArgumentResolver.class);

    private final boolean annotationNotRequired;

    public SsmSecureModelAttributeMethodArgumentResolver(boolean annotationNotRequired) {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        SsmSecureModelAttribute annot = parameter.getParameterAnnotation(SsmSecureModelAttribute.class);
        ...
        for (String clearField : clearFields) {
            if (StringUtils.hasText(clearField)) {
                SsmReflectionUtils.invokeMethod(SsmReflectionUtils.getFieldValue(attribute, clearField), "clear", null, null);
            }
        }
	...
	public boolean supportsParameter(MethodParameter parameter) {
		if (parameter.hasParameterAnnotation(SsmSecureModelAttribute.class)) {
            return true;
