...
(function ($) {
	...
	function initTaskBlank(target) {
		...
		if ($.support.leadingWhitespace) { //兼容ie的hover
	...
	$.fn.app.defaults = {
		...
		iframeOpen : false,
		loadUrl : { //远程数据加载路径
			app : ctxStatic+'/js/jquery/easyui-1.4.2/extend/app/apps.json', //app数据
			startMenu : ctxStatic+'/js/jquery/easyui-1.4.2/extend/app/startMenu.json', //开始菜单数据
			widget : ctxStatic+'/js/jquery/easyui-1.4.2/extend/app/widget.json'
		},
		lang : { //国际化
			initLayout : "初始化布局",
